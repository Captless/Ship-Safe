...
RULES: list[Rule] = [
    Rule(
        rule_id="PAY-100",
        title="Payment provider referenced",
        category="payments",
        severity=Severity.INFO,
        confidence=Confidence.MEDIUM,
        description="A payment provider or SDK is referenced in the code.",
        why_it_matters="Presence of payment-related code makes the payment security checks relevant to this project.",
        recommendation="",
        ai_fix_prompt="",
        is_presence_signal=True,
        evidence_signal="Payment provider or SDK referenced (Stripe, PayPal, or similar)",
        patterns=[r"(?i)\b(stripe|paypal|braintree|square|adyen|paddle|lemonsqueezy|chargebee|recurly)\b"],
    ),
    Rule(
        rule_id="PAY-101",
        title="Payment or checkout flow detected",
        category="payments",
        severity=Severity.INFO,
        confidence=Confidence.MEDIUM,
        description="Payment or checkout related code was detected.",
        why_it_matters="Presence of payment-related code makes the payment security checks relevant to this project.",
        recommendation="",
        ai_fix_prompt="",
        is_presence_signal=True,
        evidence_signal="Payment or checkout flow code found",
        patterns=[r"(?i)\b(checkout|payment|paywall|subscription|invoice|billing|charge)\b"],
    ),
    Rule(
        rule_id="PAY-001",
